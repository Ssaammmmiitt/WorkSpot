            ...
            <div className="grid gap-y-4">
              <div>
                ...
                <div className="relative">
                  <input type="email" id="email" name="email" className="py-3 px-4 block w-full border-2 border-Secondary rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm hover:border-black " required aria-describedby="email-error"/>
                </div>
                <p className="hidden text-xs text-red-600 mt-2" id="email-error">Please include a valid email address so we can get back to you</p>
              </div>
              <div className="flex justify-center items-center">
              <Link to="/reset-otp" href="#_" className="relative flex justify-center w-[50%] px-5 py-3 overflow-hidden font-medium text-Text bg-gray-100 border border-gray-100 rounded-lg shadow-inner group">

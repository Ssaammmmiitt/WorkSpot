          ...
          <div className="p-4 sm:p-7">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-Text ">
                ...
                <Link
                  to="/login"
                  className="text-Accent decoration-2 hover:underline font-medium"
                  href="#"
                >
                  Login here
                </Link>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        id="email"
                        name="email"
                        className="py-3 px-4 block w-full border-2 border-Secondary rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm hover:border-black "
                        required

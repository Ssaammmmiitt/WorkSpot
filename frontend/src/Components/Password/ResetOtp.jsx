...
const Otp =() =>
    {
        ...
        <div className="w-full max-w-md px-8 py-10 bg-white rounded-lg shadow-md border-2 border-Primary">
            ...
            <p className="text-Text text-center mb-4">Code sent to ${`abcd@email.xyz`}</p>
            <div className="grid grid-cols-5 gap-x-4 my-2">
            <div contenteditable="true"  className="rounded-lg bg-gray-100 cursor-text  w-14 aspect-square flex items-center justify-center">
            ...
            <div className="flex items-center space-x-2">
                ...
                <button className="px-3 py-2 text-sm font-medium text-center rounded text-Text hover:text-blue-500 ">Request Again (00:00:36)</button>
            </div>
            </div>

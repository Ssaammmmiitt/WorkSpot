...
const SignUp1 = () => {
  ...
  const onSubmit = async (data) => {
    ...
    sendData.append("currentCompany", data.currentCompany);
    sendData.append("resumeCV", data.resumeCV[0]);
    sendData.append("bio", data.bio);
    sendData.append("jobTitle", data.jobTitle);
    sendData.append("workExperience", data.workExperience);
    sendData.append("jobTypes", data.jobTypes);
    sendData.append("jobLocation", data.jobLocation);
    sendData.append("remoteWorking", data.remoteWorking);
    sendData.append("linkedinUrl", data.linkedinUrl);
    sendData.append("twitterUrl", data.twitterUrl);
    sendData.append("githubUrl", data.githubUrl);
    sendData.append("portfolioUrl", data.portfolioUrl);
    sendData.append("otherWebsite", data.otherWebsite);

    await axios.post("/user/signup", sendData, {
      headers: {
      }
    }
    ).then((res) => {

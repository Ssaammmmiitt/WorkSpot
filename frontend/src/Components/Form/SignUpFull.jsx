    ...
    <form>
      ...
      <div className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200  ">
        ...
        <div className="sm:col-span-3 ">
          <label htmlFor="af-submit-application-full-name" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Full name
          </label>
        </div>
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-email" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Email
          </label>
        </div>
        ...
        <div className="sm:col-span-3">
          <div className="inline-block">
            <label htmlFor="af-submit-application-phone" className="inline-block text-sm font-medium text-Text mt-2.5  ">
              Phone
            </label>
          </div>
        </div>
        ...
        <div className="sm:col-span-3">
          <div className="inline-block">
            <label htmlFor="af-submit-application-current-company" className="inline-block text-sm font-medium text-Text mt-2.5  ">
              Current Company
            </label>
          </div>
        </div>
      ...
      <div className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200  ">
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-resume-cv" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Resume/CV
          </label>
        </div>
        ...
        <div className="sm:col-span-3">
          <div className="inline-block">
            <label htmlFor="af-submit-application-bio" className="inline-block text-sm font-medium text-Text mt-2.5  ">
              Personal Summary
            </label>
          </div>
        </div>
      ...
      <div className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200  ">
        ...
        <div className="col-span-3 ">
          <label htmlFor="af-submit-application-desired-salary" className="block text-sm font-medium text-Text mt-2.5 row-span-3  ">
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-available-start-date" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Work Experience
          </label>
        </div>
      ...
      <div className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200  ">
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-desired-salary" className="inline-block text-sm font-medium text-Text mt-2.5  ">
        ...
        <div className="sm:col-span-3">
          <label htmlFor="job-location" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Job Location
          </label>
        </div>
        ...
        <div className="mt-5 col-span-9">
          ...
          <label htmlFor="af-submit-application-privacy-check" className=" text-sm font-medium text-bold text-Text ms-2  ">Select option for Remote Working</label>
        </div>
      ...
      <div className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200  ">
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-linkedin-url" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            LinkedIn URL
          </label>
        </div>
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-twitter-url" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Twitter URL
          </label>
        </div>
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-github-url" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Github URL
          </label>
        </div>
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-portfolio-url" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Portfolio URL
          </label>
        </div>
        ...
        <div className="sm:col-span-3">
          <label htmlFor="af-submit-application-other-website" className="inline-block text-sm font-medium text-Text mt-2.5  ">
            Other website
          </label>
        </div>
      ...
      <div className="flex justify-center">
        <button href="#_" className="relative rounded px-5 py-2.5 overflow-hidden group bg-Primary  hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300">

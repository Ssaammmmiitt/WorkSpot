...
//             <div className="relative">
//             <input type={(!showConfirmPassword)?"password":"text"} name="password" id="password" placeholder="*****" className="w-full px-3 py-2 border rounded-md pr-10 " />
//             <span className="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer">
    ...
    <div className="mt-7 bg-white border-4 border-Primary rounded-xl shadow-sm max-w-md mx-auto">
      <div className="p-4 sm:p-7">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-Text">
            Already have an account?
            <Link to='/login' className="text-blue-600 decoration-2 hover:underline font-semibold">Sign in here</Link>
          </p>
        </div>

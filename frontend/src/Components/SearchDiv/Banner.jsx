...
const Banner = ({query,handleInputChange}) => {
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
            <h1 className='text-5xl font-bold text-Text mb-3   animate__animated animate__zoomInLeft'>Kickstart your <span className='text-Primary'>new job</span> search today.</h1>
            ...
            <form>
                <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4 animate__animated animate__wobble'>
                    ...
                    <button disabled={true} className='bg-Primary py-2 px-8 ml-2 text-white md:rounded-s-none rounded mt-2 '>Find Jobs</button>
